...
<template>
  <div
    class="text-secondary-darker dark:text-white bg-cloud-surface dark:bg-sky-darkest"
  >
    <div
    ...
    >
      <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        ...
        <div
          class="mt-4 bg-white dark:bg-sky-darker overflow-hidden shadow sm:rounded-lg"
        >
          <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="p-6">
              <div class="flex items-center">
                <svg
                  class="w-6 h-6 text-cloud-dark dark:text-cloud-light"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <div class="ml-4 text-lg leading-7 font-semibold">
                  <a
                    ...
                    target="_blank"
                    rel="noopener"
                    class="hover:underline text-sky-black dark:text-white"
            ...
            <div
              class="p-6 border-t border-gray-200 dark:border-sky-darkest md:border-t-0 md:border-l"
            >
              <div class="flex items-center">
                <svg
                  class="w-6 h-6 text-cloud-dark dark:text-cloud-light"
        ...
        >
          <p>
            To remove this welcome page,
            <strong class="font-bold">you have 2 options</strong>:
          </p>
          <ul class="list-inside list-disc pt-1 pl-2">
            ...
            <li>Create a <code class="text-primary"><nuxt-link to="/store/">pinia</nuxt-link></code></li>
          </ul>
        </div>
      </div>
    </div>
...
<style scoped>
  ...
  .border-cloud-light {
    --tw-border-opacity: 1;
    border-color: rgba(146, 173, 173, var(--tw-border-opacity));
  }
  .border-t {
  ...
  .text-secondary-darker {
    --tw-text-opacity: 1;
    color: rgba(0, 53, 67, var(--tw-text-opacity));
  }
  .text-cloud-dark {
    --tw-text-opacity: 1;
    color: rgba(86, 107, 107, var(--tw-text-opacity));
  }
  .text-sky-black {
    --tw-text-opacity: 1;
  ...
  @media (prefers-color-scheme: dark) {
    ...
    .dark\:border-sky-darkest {
      --tw-border-opacity: 1;
      border-color: rgba(1, 42, 53, var(--tw-border-opacity));
    }
    .dark\:border-sky {
      --tw-border-opacity: 1;
      border-color: rgba(73, 122, 135, var(--tw-border-opacity));
    }
    .dark\:text-white {
      --tw-text-opacity: 1;
      color: rgba(255, 255, 255, var(--tw-text-opacity));
    }
    .dark\:text-cloud-light {
      --tw-text-opacity: 1;
